...
class NECTablesWireDerate():
	...
	#--75--#
	cu_ampacity_75 = [20,25,35,50,65,85,100,115,130,150,175,200,230,255,285,310,335,380,420,460,475]
	...
	al_ampacity_75 = [20,30,40,50,65,75,90,100,120,135,155,180,205,230,250,270,310,340,375,385,395,425,445]
...
se_lst = [3.1, 3.9, 5.1, 6.1, 7.1, 7.7, 10.1, 11.5]
"""INVERTER SELECT"""
